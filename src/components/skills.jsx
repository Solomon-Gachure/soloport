...
const Skills = () => {
  return (
    <div name='skills' className='w-full min-h-screen bg-black'>
...
<p className='text-gray-300 py-2'>As a Software Craftsman the following are my tools for work:</p>
</div>
          <div className='w-full grid grid-cols-2 sm:grid-cols-3 gap-4 text-center py-8'>
    <div className='hover:scale-110 duration-500'>
        <img className='w-20 mx-auto ' src={HTML} alt="Html icon"></img>
        <p className='text-gray-300 my-4'>HTML</p>
    </div>
              <div className='hover:scale-110 duration-500'>
